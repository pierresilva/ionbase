...
// generated section
    ...
    public function index(Request $request)
    {
        ...
        // (3)paginate
        $userRoles = $userRoles->paginate($request->get('per_page') ?? 10);
    ...
    public function create()
    {
        // user_can(['user_role.create']);
            ...
            return response()->json([
              'message' => 'Formulario para USUARIOSROLE obtenido!',
              'data' => null,
