...
// generated section
    ...
    public function index(Request $request)
    {
        ...
        // (3)paginate
        $userPermissions = $userPermissions->paginate($request->get('per_page') ?? 10);
    ...
    public function create()
    {
        // user_can(['user_permission.create']);
            ...
            return response()->json([
              'message' => 'Formulario para USUARIOSPERMISO obtenido!',
              'data' => null,
