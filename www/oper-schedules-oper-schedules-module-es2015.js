...
/* harmony import */ var _shared_services_camera_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../@shared/services/camera.service */ "./src/app/@shared/services/camera.service.ts");
...
let OperScheduleContractorIoComponent = class OperScheduleContractorIoComponent {
    constructor(operSchedulesService, api, loading, splitPanel, barcodeScanner, platform, http, router, camera, auth) {
    ...
    movementEnd(operMovementId) {
        this.uploadPhoto(operMovementId).then((cameraRes) => {
    ...
    uploadPhoto(operMovementId) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return yield this.camera.addNewToGallery(operMovementId, 'OperMovement', 'complete');
        });
    }
};
