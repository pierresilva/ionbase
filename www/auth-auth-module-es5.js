                  ...
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      this.api.syncPost(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].serverUrl + '/api/auth/login', this.model).then(function (res) {
                        ...
                        _this.api.syncGet(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].serverUrl + '/api/jwt-auth/profile?token=' + res.data.access_token).then(function (res) {
