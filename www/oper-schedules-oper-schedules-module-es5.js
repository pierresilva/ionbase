(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["oper-schedules-oper-schedules-module"], {
    ...
    function srcAppOperSchedulesOperScheduleContractorIoOperScheduleContractorIoComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _shared_services_camera_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      var OperScheduleContractorIoComponent = /*#__PURE__*/function () {
        function OperScheduleContractorIoComponent(operSchedulesService, api, loading, splitPanel, barcodeScanner, platform, http, router, camera, auth) {
        ...
        _createClass(OperScheduleContractorIoComponent, [{
          ...
          value: function getMovements() {
            ...
            for (var i = 0; i < this.auth.getRoles().length; i++) {
            ...
            if (!this.isAdmin) {
              ...
              this.api.get('oper-contractors?q[user_id:eq]=' + userId).subscribe(function (res) {
                console.log(res.data);

                _this.api.get('oper-movements/list?oper_contractor_id=' + res.data[0].id).subscribe(function (resMovements) {
                  _this.movements = resMovements.data;
                });
              });
            }
            ...
            if (this.isAdmin) {
              this.api.get('oper-movements/list').subscribe(function (res) {
                console.log(res.data);
                _this.movements = res.data;
              });
            }
          }
        }, {
          ...
          value: function mobileScan() {
            ...
            this.barcodeScanner.scan().then(function (barcodeData) {
              ...
              _this2.barcodeData = barcodeData;
            })["catch"](function (err) {
          ...
          key: "movementCheck",
          value: function movementCheck(operSectorId) {
            var _this3 = this;
            ...
            this.api.post('oper-movements/check', {
              ...
              if (err.status == 401) {
                _this3.router.navigateByUrl('/auth/logout');
              }
            });
          }
        }, {
          key: "movementStart",
          value: function movementStart(operScheduleId) {
            var _this4 = this;
            ...
            this.api.post('oper-movements/start', {
              ...
              _this4.movementCheck(_this4.barcodeData.text);
            }, function (err) {
              console.log(err);
            });
          }
          ...
          key: "movementEnd",
          value: function movementEnd(operMovementId) {
            var _this5 = this;

            this.uploadPhoto(operMovementId).then(function (cameraRes) {
              _this5.api.post('oper-movements/end', {
                oper_movement_id: operMovementId,
                photo: cameraRes.data.url
              }).subscribe(function (res) {
                console.log(res);

                _this5.movementCheck(_this5.barcodeData.text);
              }, function (err) {
                console.log(err);
              });
            });
          ...
          key: "uploadPhoto",
          value: function uploadPhoto(operMovementId) {
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.next = 2;
                      return this.camera.addNewToGallery(operMovementId, 'OperMovement', 'complete');
      ...
      OperScheduleContractorIoComponent.ctorParameters = function () {
        return [{
          ...
          type: _shared_services_camera_service__WEBPACK_IMPORTED_MODULE_11__["CameraService"]
        }, {
        ...
        _createClass(OperSchedulesCreateComponent, [{
          ...
          value: function ngAfterViewInit() {
            ...
            this.operScheduleForm.operSchedulesForm.valueChanges.subscribe(function (data) {
              _this6.operSchedulesService.operSchedulesFormValid.next(_this6.operScheduleForm.operSchedulesForm.valid);
            });
          }
        }, {
          key: "clearPosts",
      ...
      var OperSchedulesEditComponent = /*#__PURE__*/function () {
        ...
        _createClass(OperSchedulesEditComponent, [{
          ...
          value: function ngAfterViewInit() {
            ...
            this.operScheduleForm.operSchedulesForm.valueChanges.subscribe(function (data) {
              _this7.operSchedulesService.operSchedulesFormValid.next(_this7.operScheduleForm.operSchedulesForm.valid);
            });
          }
        }]);
        ...
        _createClass(OperSchedulesService, [{
          ...
          value: function getOperSchedules() {
            ...
            this.api.get(this.operSchedulesUrl + '?page=' + page + '&perPage=' + perPage + '&q[name:cont]=' + this.searchValue + (userId ? '&q[operContractor.user_id:id]=' + userId : '') + (date ? '&q[next:cont]=' + date : '') + (own ? '&q[s]=time_start:asc' : '')).subscribe(function (res) {
              ...
              _this8.operSchedules = res.data;
              _this8.operScheduleLists = res.lists;
              _this8.meta = res.meta;
            }, function (err) {
              console.error(err);
            });
          }
          ...
          value: function editOperSchedule(id) {
            ...
            this.api.get(this.operSchedulesUrl + '/' + id + '/edit').subscribe(function (res) {
              _this9.operSchedule = res.data.model;
              _this9.operScheduleLists = res.lists;
            }, function (err) {
              console.error(err);
            });
          }
          ...
          value: function updateOperSchedule() {
            ...
            this.api.put(this.operSchedulesUrl + '/' + this.operSchedule.id, {
              ...
              _this10.navigation.back();

              _this10.getOperSchedules(1);
            });
          }
        }, {
          ...
          value: function createOperSchedule() {
            ...
            this.api.get(this.operSchedulesUrl + '/create').subscribe(function (res) {
              _this11.operSchedule = {};
              _this11.operScheduleLists = res.lists;
            });
          }
        }, {
