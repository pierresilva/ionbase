      ...
      var OperMachinesService = /*#__PURE__*/function () {
        ...
        _createClass(OperMachinesService, [{
          ...
          value: function getOperMachines() {
            ...
            this.api.get(this.operMachinesUrl + '?page=' + page + '&perPage=' + perPage + '&q[name:cont]=' + this.searchValue + '&q[inventory_code:cont]=' + this.searchValue).subscribe(function (res) {
              // @ts-ignore
