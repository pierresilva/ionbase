              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  @if ( $query_params = Request::input('q') )
                      ...
                      <li class="breadcrumb-item active"><a href="{{ route('operReplacements.index') }}">{{ $model_title_list['operReplacements'] }}</a></li>
                  ...
                  @else
                      <li class="breadcrumb-item active">{{ $model_title_list['operReplacements'] }}</li>
                  @endif
              ...
              <div class="card">
                  <div class="card-body">
                      <h1 class="d-flex mb-3">
                          ...
                          <span class="d-inline-block">{{ $model_title_list['operReplacements'] }}</span>
                          <a class="btn btn-success d-inline-flex ml-auto" href="{{ route('operReplacements.create') }}"><i class="material-icons align-self-center mr-1">add_circle</i><span class="align-self-center">Create</span></a>
                      </h1>
                      ...
                      <div class="collapse mb-4" id="search-area">
                        <div class="card card-body">
                          ...
                          <form id="search" action="{{ route('operReplacements.index') }}" accept-charset="UTF-8" method="get">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <input class="form-control form-control-sm" id="q_time_cont" name="q[time:cont]" type="search" value="{{ @(Request::input('q.time:cont')) }}">
                                                                                                                                                                        ...
                                                                                                                                                                        <div class="form-group row">
                              <label for="q_warranty_cont" class="col-sm-2 col-form-label col-form-label-sm">GARANTIA</label>
                              <div class="col-sm-10">
                                <input class="form-control form-control-sm" id="q_warranty_cont" name="q[warranty:cont]" type="search" value="{{ @(Request::input('q.warranty:cont')) }}">
                              </div>
                            </div>
                      ...
                      @include('operReplacements._table')
                  </div>
              </div>
          </div>
      </div>
