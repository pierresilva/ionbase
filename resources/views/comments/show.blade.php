                  ...
                  <div class="card-body">
                      ...
                      <ul class="list-group list-group-flush mt-4">
                        <li class="list-group-item d-inline-flex flex-wrap"><div><strong>ID ： </strong></div><div>{{$comment->id}}</div></li>
                                                                              ...
                                                                              <li class="list-group-item d-inline-flex flex-wrap"><div><strong>NOMBRE : </strong></div><div>{{ $comment->name }}</div></li>
                                                                                                                  <li class="list-group-item d-inline-flex flex-wrap"><div><strong>CUERPO : </strong></div><div>{{ $comment->body }}</div></li>
                                                                                          
                                                            <li class="list-group-item d-inline-flex flex-wrap"><div><strong>ENTRADAS : </strong></div><div>{{ $comment->post->name ?? '' }}</div></li>
