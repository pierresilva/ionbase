              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  @if ( $query_params = Request::input('q') )
                      ...
                      <li class="breadcrumb-item active"><a href="{{ route('images.index') }}">{{ $model_title_list['images'] }}</a></li>
                  ...
                  @else
                      <li class="breadcrumb-item active">{{ $model_title_list['images'] }}</li>
                  @endif
              ...
              <div class="card">
                  <div class="card-body">
                      <h1 class="d-flex mb-3">
                          ...
                          <span class="d-inline-block">{{ $model_title_list['images'] }}</span>
                          <a class="btn btn-success d-inline-flex ml-auto" href="{{ route('images.create') }}"><i class="material-icons align-self-center mr-1">add_circle</i><span class="align-self-center">Create</span></a>
                      </h1>
                      ...
                      <div class="collapse mb-4" id="search-area">
                        <div class="card card-body">
                          ...
                          <form id="search" action="{{ route('images.index') }}" accept-charset="UTF-8" method="get">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <input class="form-control form-control-sm" id="q_url_cont" name="q[url:cont]" type="search" value="{{ @(Request::input('q.url:cont')) }}">
                                                                                                                                            ...
                                                                                                                                            <div class="form-group row">
                              <label for="q_post_id_cont" class="col-sm-2 col-form-label col-form-label-sm">ENTRADAS<br>belongsToMany</label>
                              <div class="col-sm-10">
                                {{--<input class="form-control form-control-sm" id="q_post_id_cont" name="q[posts.post_id:eq]" type="search" value="{{ @(Request::input('q.posts.post_id:eq')) }}">--}}
                                <select class="form-control"
                                    id="q_post_id_eq"
                                    name="q[posts.post_id:eq]">
                                <option value=""></option>
                                @foreach( $lists["Post"] as $list_key => $list_item )
                                    <option value="{{ $list_key }}"
                                    @if( $list_key == @(Request::input('q.posts.post_id:eq')) )  selected='selected' @endif
                                    >{{ $list_item }}</option>
                                @endforeach
                                </select>
                              </div>
