(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["corr-packets-corr-packets-module"], {
    ...
    function srcAppCorrPacketsCorrPacketsCreateCorrPacketsCreateComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _shared_classes_form_validation_errors__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../@shared/classes/form-validation-errors */
      "./src/app/@shared/classes/form-validation-errors.ts");

      var CorrPacketsCreateComponent = /*#__PURE__*/function () {
        function CorrPacketsCreateComponent(corrPacketsService, route, platform) {
        ...
        _createClass(CorrPacketsCreateComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {// this.clearPosts();
          }
        }, {
          key: "ngAfterViewInit",
          value: function ngAfterViewInit() {
            ...
            this.corrPacketForm.corrPacketsForm.valueChanges.subscribe(function (data) {
              console.log(Object(_shared_classes_form_validation_errors__WEBPACK_IMPORTED_MODULE_5__["getFormValidationErrors"])(_this.corrPacketForm.corrPacketsForm.controls));
      ...
      var CorrPacketsEditComponent = /*#__PURE__*/function () {
        ...
        _createClass(CorrPacketsEditComponent, [{
          ...
          value: function ngAfterViewInit() {
            ...
            this.corrPacketForm.corrPacketsForm.valueChanges.subscribe(function (data) {
              console.log(Object(_shared_classes_form_validation_errors__WEBPACK_IMPORTED_MODULE_5__["getFormValidationErrors"])(_this2.corrPacketForm.corrPacketsForm.controls));
      ...
      var CorrPacketsFormComponent = /*#__PURE__*/function () {
        function CorrPacketsFormComponent(corrPacketsService, toTitlecase, housUnitsService, camera, modalController) {
          ...
          this.validationMessages = {
            ...
            'conveyor': [{
              type: 'required',
              message: 'El campo ' + this.toTitlecase.transform('TRANPORTADOR') + ' es obligatorio.'
            }],
            'guide_number': [{
              type: 'required',
