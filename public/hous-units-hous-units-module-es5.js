  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["hous-units-hous-units-module"], {
    ...
    function srcAppHousUnitsHousUnitsFormHousUnitsFormComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var HousUnitsFormComponent = /*#__PURE__*/function () {
        function HousUnitsFormComponent(housUnitsService, toTitlecase, splitPanel) {
          ...
          this.validationMessages = {
            ...
            'contact_first_name': [{
              type: 'required',
              message: 'El campo nombre del contacto es obligatorio.'
            }],
            'contact_last_name': [{
              type: 'required',
              message: 'El campo apellido del contacto es obligatorio.'
            }],
            'contact_phone': [{
              type: 'required',
              message: 'El campo teléfono del contacto es obligatorio.'
            }],
            'contact_email': [{
              type: 'required',
              message: 'El campo email del contacto es obligatorio.'
            }, {
              type: 'email',
              message: 'El campo email del contacto no es valido.'
            }]
          };
        }
