...
let SelectInputComponent = SelectInputComponent_1 = class SelectInputComponent {
    constructor() {
        this.list = [];
        this.label = '';
        this.value = null;
...
SelectInputComponent.propDecorators = {
    ...
    minlength: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['minlength',] }],
    maxlength: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['maxlength',] }],
    name: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['name',] }],
    itemValueField: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['itemValueField',] }],
    itemTextField: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['itemTextField',] }],
    isMultiple: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['isMultiple',] }]
};
SelectInputComponent = SelectInputComponent_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-select-input',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./select-input.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/@shared/components/select-input/select-input.component.html")).default,
        providers: [{
                provide: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NG_VALUE_ACCESSOR"],
                useExisting: SelectInputComponent_1,
                multi: true
            }],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./select-input.component.scss */ "./src/app/@shared/components/select-input/select-input.component.scss")).default]
    })
...
let AuthService = class AuthService {
    ...
    login(credentials, redirect = true) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.api.syncPost('api/jwt-auth/login', credentials)
                ...
                yield this.api.syncGet('api/jwt-auth/profile')
                    .then((res) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                    const user = {
    ...
    refreshToken() {
        this.api.syncPost('api/jwt-auth/refresh', {})
            ...
            yield this.router.navigateByUrl('/auth');
        }));
    }
...
let StartupService = class StartupService {
    ...
    load() {
        return new Promise((resolve) => {
            Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["zip"])(this.httpClient.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].serverUrl}/api/syst-parameters/all`))
...
/* harmony import */ var _components_select_input_select_input_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./components/select-input/select-input.component */ "./src/app/@shared/components/select-input/select-input.component.ts");
/* harmony import */ var _services_toast_service__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./services/toast.service */ "./src/app/@shared/services/toast.service.ts");
/* harmony import */ var ngx_summernote__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ngx-summernote */ "./node_modules/ngx-summernote/__ivy_ngcc__/fesm2015/ngx-summernote.js");
/* harmony import */ var _pipes_strip_html_pipe__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./pipes/strip-html.pipe */ "./src/app/@shared/pipes/strip-html.pipe.ts");
/* harmony import */ var _services_file_transfer_service__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./services/file-transfer.service */ "./src/app/@shared/services/file-transfer.service.ts");
/* harmony import */ var _ionic_native_file_opener_ngx__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! @ionic-native/file-opener/ngx */ "./node_modules/@ionic-native/file-opener/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _zxing_ngx_scanner__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! @zxing/ngx-scanner */ "./node_modules/@zxing/ngx-scanner/fesm2015/zxing-ngx-scanner.js");
/* harmony import */ var _services_file_upload_service__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./services/file-upload.service */ "./src/app/@shared/services/file-upload.service.ts");
/* harmony import */ var _services_navigation_service__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./services/navigation.service */ "./src/app/@shared/services/navigation.service.ts");
/* harmony import */ var _pipes_status_pipe__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./pipes/status.pipe */ "./src/app/@shared/pipes/status.pipe.ts");
/* harmony import */ var _pipes_date_format_pipe__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./pipes/date-format.pipe */ "./src/app/@shared/pipes/date-format.pipe.ts");
/* harmony import */ var angular2_signaturepad__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! angular2-signaturepad */ "./node_modules/angular2-signaturepad/__ivy_ngcc__/index.js");
/* harmony import */ var angular2_signaturepad__WEBPACK_IMPORTED_MODULE_40___default = /*#__PURE__*/__webpack_require__.n(angular2_signaturepad__WEBPACK_IMPORTED_MODULE_40__);
/* harmony import */ var _pipes_zero_leading_pipe__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./pipes/zero-leading.pipe */ "./src/app/@shared/pipes/zero-leading.pipe.ts");
/* harmony import */ var _pipes_get_parameter_pipe__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ./pipes/get-parameter.pipe */ "./src/app/@shared/pipes/get-parameter.pipe.ts");
/* harmony import */ var ng2_validation__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ng2-validation */ "./node_modules/ng2-validation/__ivy_ngcc__/dist/index.js");
/* harmony import */ var ng2_validation__WEBPACK_IMPORTED_MODULE_43___default = /*#__PURE__*/__webpack_require__.n(ng2_validation__WEBPACK_IMPORTED_MODULE_43__);
/* harmony import */ var ionic4_auto_complete__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! ionic4-auto-complete */ "./node_modules/ionic4-auto-complete/__ivy_ngcc__/fesm2015/ionic4-auto-complete.js");
/* harmony import */ var ngx_ionic_image_viewer__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! ngx-ionic-image-viewer */ "./node_modules/ngx-ionic-image-viewer/__ivy_ngcc__/fesm2015/ngx-ionic-image-viewer.js");
...
SharedModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _components_select_input_select_input_component__WEBPACK_IMPORTED_MODULE_29__["SelectInputComponent"],
            _pipes_strip_html_pipe__WEBPACK_IMPORTED_MODULE_32__["StripHtmlPipe"],
            _pipes_status_pipe__WEBPACK_IMPORTED_MODULE_38__["StatusPipe"],
            _pipes_date_format_pipe__WEBPACK_IMPORTED_MODULE_39__["DateFormatPipe"],
            _pipes_zero_leading_pipe__WEBPACK_IMPORTED_MODULE_41__["ZeroLeadingPipe"],
            _pipes_get_parameter_pipe__WEBPACK_IMPORTED_MODULE_42__["GetParameterPipe"],
        ],
        entryComponents: [
            _components_main_header_main_header_component__WEBPACK_IMPORTED_MODULE_4__["MainHeaderComponent"],
            _components_popover_popover_component__WEBPACK_IMPORTED_MODULE_25__["PopoverComponent"],
        ...
        exports: [
            ...
            ngx_summernote__WEBPACK_IMPORTED_MODULE_31__["NgxSummernoteModule"],
            _zxing_ngx_scanner__WEBPACK_IMPORTED_MODULE_35__["ZXingScannerModule"],
            angular2_signaturepad__WEBPACK_IMPORTED_MODULE_40__["SignaturePadModule"],
            ionic4_auto_complete__WEBPACK_IMPORTED_MODULE_44__["AutoCompleteModule"],
            ngx_ionic_image_viewer__WEBPACK_IMPORTED_MODULE_45__["NgxIonicImageViewerModule"],
            _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpClientModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_28__["FormsModule"],
            ng2_validation__WEBPACK_IMPORTED_MODULE_43__["CustomFormsModule"],
        ...
        providers: [
            ...
            _ionic_native_file_opener_ngx__WEBPACK_IMPORTED_MODULE_34__["FileOpener"],
            ...
            _services_toast_service__WEBPACK_IMPORTED_MODULE_30__["ToastService"],
            _services_file_transfer_service__WEBPACK_IMPORTED_MODULE_33__["FileTransferService"],
            _services_file_upload_service__WEBPACK_IMPORTED_MODULE_36__["FileUploadService"],
            _services_navigation_service__WEBPACK_IMPORTED_MODULE_37__["NavigationService"],
            {
...
const routes = [
    ...
    {
        path: 'setting-groups',
        loadChildren: () => Promise.all(/*! import() | setting-groups-setting-groups-module */[__webpack_require__.e("common"), __webpack_require__.e("setting-groups-setting-groups-module")]).then(__webpack_require__.bind(null, /*! ./setting-groups/setting-groups.module */ "./src/app/setting-groups/setting-groups.module.ts")).then(m => m.SettingGroupsPageModule)
    },
];
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, loading, splitPanel) {
        this.platform = platform;
