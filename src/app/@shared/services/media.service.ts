...
export class MediaService {
    ...
    private readonly matchOperators: MatchOperator[] = [
        ...
        {
            operator: null,
            match: (breakpoint: MediaBreakpoint) =>
                window.innerWidth >= breakpoint.minWidth && window.innerWidth <= breakpoint.maxWidth,
        },
    ];
    ...
    private getWindowMedia(): Media {
        return {
            alias: this.mediaBreakpoints.find((breakpoint: MediaBreakpoint) => window.innerWidth <= breakpoint.maxWidth)
                .alias,
